require_relative 'lib/churned/version'

Gem::Specification.new do |spec|
  spec.name          = "churned"
  spec.license       = "MIT"
  spec.version       = Churned::VERSION
  spec.authors       = ["Alexandre Barret"]
  spec.email         = ["hello@alexbarret.com"]

  spec.summary       = "CLI too to help monitor the health of a git repository"
  # spec.description   = %q{TODO: Write a longer description or delete this line.}
  spec.homepage      = "https://github.com/AlexB52/churned"
